        ...
        <MainSection>
          <Container>
            ...
            <Flex align="top" justify="space-between">
              <Introduction>
                Hi! I’m Nenad, a front-end web developer based in
                Vienna, Austria. My expertise lies in building
                websites and web interfaces using modern technologies
                like React and Vue. I find great joy in the field of
                web development — it’s a journey filled with
                challenges, constant learning, and the chance to bring
                a creative touch to each project.
              </Introduction>
              <Image
            ...
            <div className="about-paragraph">
              ...
              <p>
                ...
                genuine interest in contributing to{' '}
                <a
                  className="a-link"
                ...
                whenever I can. I also take pleasure in developing my
                own{' '}
                <Link className="a-link" href="/projects">
                  projects
                </Link>
                , primarily using React and TypeScript. Developing
                them offers me the freedom to experiment with design,
                or just to test different approaches and technologies,
